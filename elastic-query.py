...
def main():
    ...
    desc = ('Query elasticsearch indexes for logs, using a pods name and'
            ' namespace, or by label values for the pods application, component'
            ', and namespace.'
            ' ex. \"elastic-query.py'
            ' --query pod'
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        help='The Kubernetes label "application" on the pod(s) to retrive logs for')
    parser.add_argument(
        '--component',
        metavar='component',
        type=str,
        required=False,
        help='The kubernetes label "component" on the pod(s) to retrieve logs for')
    parser.add_argument(
        '--namespace',
        metavar='namespace',
        type=str,
    ...
    if args.query == "pod":
        ...
        search = label_query(es, args.app, args.component, args.namespace, args.index)
    else:
